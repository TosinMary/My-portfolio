      ...
      <h3>Software Testing Sample Projects</h3>
       <section className='project-container'>
            <div className='project'>
             ...
             <div className='project'>
                <div className='img-container'>
                  <h4>API Automation with Postman</h4>
                </div>
                <div className='project-summary'>
                  <div >
                   <h4>API Automation: <a href='https://www.postman.com/api-test-1186/workspace/zedu/collection/42497516-cce2356d-6dbb-40c3-88ee-b790282f7c29?action=share&source=copy-link&creator=42497516' className='project-icon' target='_blank'><FaExternalLinkAlt /></a></h4>
                  </div>
                </div>
            </div>
             <div className='project'>
                ...
                <div className='project-summary'>
                  <div >
                   <h4>Test Plan Doc: <a href='https://docs.google.com/document/d/12a5yGWC5Uct5lvKhu4-JhK2fbalOsxaRNj74mAu281w/edit?usp=sharing' className='project-icon' target='_blank'><FaExternalLinkAlt /></a></h4> <br></br>
                    <h4>Test Plan Doc: <a href='https://docs.google.com/document/d/1HEbXRRAHDmnChEyl1kE0cUXgSYN2OPwx8V92mmV1hlo/edit?usp=sharing'className='project-icon' target='_blank'><FaExternalLinkAlt /></a></h4>
                  </div>
                </div>
            </div>
            <div className='project'>
                ...
                <div className='project-summary'>
                  <div >
                   <h4>Bug Report: <a href='https://docs.google.com/spreadsheets/d/1TlcBE5JuGI3nrOYt04eqRx8XVK2Z46zRlKz_gYtIvlc/edit?usp=sharing' className='project-icon' target='_blank'><FaExternalLinkAlt /></a></h4> <br></br>
                    <h4>API Bug Report: <a href='https://docs.google.com/spreadsheets/d/1jZL_R9qFHs0dz-j-C-2__Dp0of4dN1gchQ3F63jiMUk/edit?usp=sharing'className='project-icon' target='_blank'><FaExternalLinkAlt /></a></h4>
                  </div>
                  </div>
                  </div>
                    <div className='project'>
                <div className='img-container'>
                  <h4>BDD Automation with RestAsured, Java and TestNG</h4>
                </div>
                <div className='project-summary'>
                  <div >
